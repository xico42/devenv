...
func TestProcess(t *testing.T) {
	...
	t.Run("env returns set var", func(t *testing.T) {
		t.Setenv("CODEHERD_TEST_SECRET", "mysecret")
		got, err := envtemplate.Process(`{{ env "CODEHERD_TEST_SECRET" "default" }}`, "test", ctx)
		if err != nil {
			t.Fatalf("Process() error = %v", err)
		}
	...
	t.Run("env unset var uses default", func(t *testing.T) {
		got, err := envtemplate.Process(`{{ env "CODEHERD_UNSET_VAR_12345" "mydefault" }}`, "test", ctx)
		if err != nil {
			t.Fatalf("Process() error = %v", err)
		}
	...
	t.Run("env unset var no default returns empty string", func(t *testing.T) {
		got, err := envtemplate.Process(`A={{ env "CODEHERD_UNSET_VAR_12345" }}B`, "test", ctx)
		if err != nil {
			t.Fatalf("Process() error = %v", err)
		}
	...
	t.Run("header present in output", func(t *testing.T) {
		...
		if !strings.HasPrefix(got, "# Generated by codeherd") {
